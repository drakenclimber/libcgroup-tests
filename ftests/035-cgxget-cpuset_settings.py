...
TABLE = [
    ...
    ['cpuset.cpus', '0', CgroupVersion.CGROUP_V1, 'cpuset.cpus', '0', CgroupVersion.CGROUP_V1],
    ['cpuset.cpus', '0', CgroupVersion.CGROUP_V1, 'cpuset.cpus', '0', CgroupVersion.CGROUP_V2],
    ['cpuset.cpus', '0', CgroupVersion.CGROUP_V2, 'cpuset.cpus', '0', CgroupVersion.CGROUP_V1],
    ['cpuset.cpus', '0', CgroupVersion.CGROUP_V2, 'cpuset.cpus', '0', CgroupVersion.CGROUP_V2],
