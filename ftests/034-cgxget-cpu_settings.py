...
TABLE = [
    ...
    ['cpu.max', '5000 75000', CgroupVersion.CGROUP_V2, 'cpu.max', '5000 75000', CgroupVersion.CGROUP_V2],
    ['cpu.max', '4000 75000', CgroupVersion.CGROUP_V2, 'cpu.cfs_quota_us', '4000', CgroupVersion.CGROUP_V1],
    ['cpu.max', '4000 74000', CgroupVersion.CGROUP_V2, 'cpu.cfs_period_us', '74000', CgroupVersion.CGROUP_V1],
    ['cpu.max', 'max 74000', CgroupVersion.CGROUP_V2, 'cpu.cfs_quota_us', '-1', CgroupVersion.CGROUP_V1],

    ['cpu.cfs_period_us', '55555', CgroupVersion.CGROUP_V1, 'cpu.cfs_period_us', '55555', CgroupVersion.CGROUP_V1],
    ['cpu.cfs_quota_us', '12345', CgroupVersion.CGROUP_V1, 'cpu.cfs_quota_us', '12345', CgroupVersion.CGROUP_V1],
    ['cpu.cfs_quota_us', '12345', CgroupVersion.CGROUP_V1, 'cpu.cfs_quota_us', '12345', CgroupVersion.CGROUP_V1],
    ['cpu.cfs_quota_us', '-1', CgroupVersion.CGROUP_V1, 'cpu.max', 'max 55555', CgroupVersion.CGROUP_V2],
]
